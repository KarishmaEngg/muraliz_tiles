    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <header className="relative h-[80vh] w-full">
        ...
        <div className="absolute inset-0">
          <img 
            src="https://TileVistatiles.com/assets/images/Our%20Products%20Banner.png" 
            alt="Hero Interior" 
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="aspect-[4/5] overflow-hidden">
            <img src="https://TileVistatiles.com/assets/images/Our%20Collections_Inside_Explore_Images/Tiles%20n%20Slabs/Tile%20Slab%202.png" alt="Interior 2" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
          </div>
          <div className="aspect-[4/5] overflow-hidden">
            <img src="https://TileVistatiles.com/assets/images/Our%20Collections_Inside_Explore_Images/Tiles%20n%20Slabs/Tile%20Slab%203.png" alt="Interior 3" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
          </div>
        </div>
      </section>
